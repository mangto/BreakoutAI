                ...
                if (self.enabled):
                    if (self.hitbox.get_at((mx, my)) == (255, 255, 255)):
                        ...
                        if (mouse.leftbtup() and (mx, my) != self.new_box[0]):
                            if (class_selector.class_name[class_selector.selected_index] not in self.borders[selected_index]):
                                self.borders[selected_index][class_selector.class_name[class_selector.selected_index]] = []
